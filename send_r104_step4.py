"""Send R104 Step 4 to 小周 via raw WebSocket."""
...
async def main():
    ...
    async with websockets.connect(uri) as ws:
        ...
        content = (
            "📋 R104 Step 4 — 代码审查 到你了！\n\n"
            "R104: Web 服务增加工作区列表 API\n\n"
            "爱泰已完成编码，commit: f984bb9\n"
            ...
            "🔍 审查内容：server/web_viewer.py 新增 handle_api_workspaces() + /api/workspaces 路由\n\n"
            "⚠️ 审查完成后回复此 inbox，前缀用：已完成 ✅ R104 Step 4"
        )
        ...
        print(f"📤 Sent R104 Step 4 to 小周 ({XIAOZHOU_ID})")
