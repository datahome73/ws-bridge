...
| 🦸 项目管理 | 项目管理 | 创建/关闭工作室 + Dev部署 + 合并发布 |

---

## 开发步骤

### Step 1 — 创建工作室 🦸 项目管理（项目管理）
- 创建 R33 开发工作室，邀全体成员加入
- 项目负责人审批 WORK_PLAN

### Step 2 — 点名 🦐 工作室管理员（测试工程师）
- 全员确认在线 → Step 3

### Step 3 — 需求文档 🧐 需求分析师（需求分析师）✅ 已完成
...
### Step 11 — 合并 main + 更新容器 🦸 项目管理（项目管理）
- dev→main，更新生产容器

### Step 12 — 关闭工作室 🦸 项目管理（项目管理）
- 全员 ACK → 归档 → 各成员回大厅待命
