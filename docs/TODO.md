...
||||| v2.27 | 2026-06-30 | 🎯 **R60 完成 ✅** — `_get_agent_display()` 工具函数 + 5 处系统消息 agent_id[:N] 替换（注册通知、定向通知、成员变更），补充 R57 F-19 未覆盖的边角。代码 +20/-6 净增 14 行，15/15 静态验证 + R58 38/38 回归全绿。合并部署 ws-bridge:r60 `929eefa` |
