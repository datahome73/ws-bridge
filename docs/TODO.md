...
| F-7 | **Web 端下拉刷新跳到大厅** — 有活跃工作室时查看最新消息，下拉刷新后跳到大厅 tab；期望保持当前活跃工作室 tab，刷新后仍在此工作室看到最新消息 | 🟡 P2 | — | ⬜ 待启动 |
...
| R36-D | **部署后 Web 端历史记录丢失** — 日志仅存当天、DB 不持久 | 🔴 P0 | — | ⬜ 待启动 |
...
|| v2.7 | 2026-06-27 | 🔄 R41 启动清理 — F-7/R36-B/C/D 清空过期轮次标记，回归待启动池 |
