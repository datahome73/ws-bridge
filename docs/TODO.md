...
| F-7 | **Web 端下拉刷新跳到大厅** — 有活跃工作室时查看最新消息，下拉刷新后跳到大厅 tab；期望保持当前活跃工作室 tab，刷新后仍在此工作室看到最新消息 | 🟡 P2 | 待分配 | ⬜ 待启动 |
...
| R37-1 | **!rollcall MSG_SET_ACTIVE_CHANNEL 未送达新连接** — B方向测试中成员连接收不到频道切换消息，工作区和成员关系正确但消息未送达。A方向（单次触发优化 + P1修复）已全部通过并合并 | 🟡 P2 | 待分配 | ⬜ 待排期 |
...
| R37-A | **R37 方向A编码 + P1修复 + WORKFLOW v5.3** — A方向全部通过，P1不可达修复闭合，WORKFLOW.md v5.3更新。B2留待后续轮次 | R37 | 🟢 已合并 |
...
| 版本 | 日期 | 变更 |
|:----:|:----:|:-----|
| v2.2 | 2026-06-24 | 📌 新增 R37 归档项 + R37-1 待分配 TODO |
