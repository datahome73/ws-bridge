...
### Step 1 — 创建工作室 🦸 小爱
- 创建 R{NN} 开发工作室，邀请全体虾加入
- **大宏审批 WORK_PLAN**（创建工作室时确认）

### Step 2 — 点名 🦸 小爱
- 全员确认在线
- 点名完成 → 推进 Step 3

### Step 3 — 需求文档 🧐 小谷 🔑（关键审核闸门）
产出：`docs/R{NN}/R{NN}-product-requirements.md`
- 小谷调研当前状态 → 编写产品需求文档
- **大宏 TG 审核** — ✅ 通过（转 Step 4）/ ❌ 驳回
...
### Step 11 — 合并 main + 更新容器 🦸 小爱
- 合并 dev→main，更新生产容器

### Step 12 — 关闭工作室 🦸 小爱
- 全员 ACK → 归档轮次文档 → 各虾切回大厅待命
