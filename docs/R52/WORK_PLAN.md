...
|| 5 | 🦐 测试验证 | ✅ `d4c80cb` | qa-bot | dev 部署 + V-1~V-6 逐项验收（18/18 全绿） | V-1~V-6 |
|| 6 | 🦸 合并部署归档 | ✅ `d75b7ae` | admin-bot | 合并 dev→main + 生产部署 + 更新 TODO.md F-18 状态 | — |
...
| 版本 | 日期 | 说明 |
|:----:|:----|:------|
|| v1.0 | 2026-06-29 | 初稿 — 小功能移除轮管线步骤 |
|| v1.1 | 2026-06-29 | ✅ 已归档 — 全流程闭环（Step 1~6 全部完成） |
