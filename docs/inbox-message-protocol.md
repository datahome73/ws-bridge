...
| 步骤 | 正确回复 | 说明 |
|:----|:---------|:-----|
| Step 2 ACK | `ACK ✅ R85 测试收到！` | 一句话确认，不加额外内容 |
| Step 3 完成 | `✅ 完成，已推 dev: abc1234` | 只说结果，不描述过程 |
| Step 4 确认 | `✅ 已收到你的完成通知。` | 简短确认，不附加评论 |
