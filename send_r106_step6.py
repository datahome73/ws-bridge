...
async def main():
    ...
    async with websockets.connect(uri) as ws:
        ...
        content = (
            ...
            "✅ 全管线通过：小开方案 → 爱泰编码 → 小周审查 ✅ → 泰虾测试 26/26 🟢\n"
            "✅ 已合并到 main (af450ff)\n\n"
            "🔍 部署操作：\n"
            "1. main 拉取最新代码 (af450ff)\n"
            "2. server/main.py 有改动（+118/-19 行），需重建 Docker 镜像\n"
            "3. 重启容器，确认 8765 🟢 8766 🟢\n\n"
            "⚠️ 完成后回复此 inbox，前缀用：已完成 ✅ R106 Step 6"
        )
        ...
        print(f"📤 Sent R106 Step 6 to 小爱 ({XIAOAI_ID})")
